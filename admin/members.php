    ...
    */
    ...
    if (isset($_SESSION['uname'])) {
        ...
        <?php
            ...
            $stmt = $conf->prepare("SELECT uname, user_ID FROM users WHERE reg_status = 0 LIMIT 5");
            $stmt -> execute();
            $rows = $stmt->fetchAll();
        ?>
            ...
            <div class="container">
                <p class="alert alert-warning member_title">Welcome, <?php echo $_SESSION['uname'];  ?></p>
                <div class="row members_row">
                    <div class="col-sm-6">
                        <div class="card member_card">
                            <p class="card-header latest_header">
                                Latest <?php echo $limit ?> Users
                            </p>
                            <div class="card-body latest_body">
        ...
        <?php }elseif ($do == 'manage') {  //Manage Page 
                    ...
                    <form action="?do=insert" method="POST">
                        <div class="user-details">
                            <div class="input-box">
                                ...
                                <input type="text" required name="fname" id="fname" placeholder="Enter First Name" autocomplete="off">
                            </div>
                            <div class="input-box">
                            ...
                            <div class="input-box">
                                ...
                                <input type="email" required name="email" id="email" placeholder="Email Must Be Valid" autocomplete="off">
                            </div>
                            <div class="input-box">
                                <span class="details">Username</span>
                                <input type="text" required name="uname" id="uname" placeholder="Username to Login" autocomplete="off">
                            </div>
                            <div class="input-box">
                                <span class="details">Password</span>
                                <input type="password" class="password" required name="pass" id="pass" placeholder="Write Complex Password" autocomplete="new-password">
        ...
        <?php }
        elseif ($do == 'insert') {  // INSERT Member In Database
                $pageTitle = 'Insert User';
                echo "<div class='container'>";
                    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                        echo "<p class='title'>Insert Member</p>";
